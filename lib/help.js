...
module.exports = `
  Usage
    ...
    Options
      ...
      --before, -x       Display items created before a specified date
      --after, -w        Display items created after a specified date
      --graph, -g        Display graphs for boards
